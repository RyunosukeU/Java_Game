...
import jp.ac.uryukyu.ie.e205236.Hands;
import jp.ac.uryukyu.ie.e205236.Status;
...
public class MainWindow {
    ...
    // ラベル
    this.messageLabel = new JLabel("じゃ〜んけ〜ん・・・！！！");
    ...
    switch ((selected.getNumber() - opponentHand.getNumber() + 3) % 3) {
        case 0:
        // 引き分けなので継続
        this.messageLabel.setText("あ〜いこ〜で・・・！！！");
        // 手を出しなおす
        this.init();
        break;
        case 1:
        // 負け
        this.messageLabel.setText(String.format("相手は「%s」を出した！お前の負けだっ！", this.opponentHand.getDisplay()));
        // ゲーム終了
        this.playState = Status.Done;
        break;
        case 2:
        // 勝ち
        this.messageLabel.setText(String.format("相手は「%s」を出した！お前の勝ちだっ！", this.opponentHand.getDisplay()));
        // ゲーム終了
        this.playState = Status.Done;
        break;
    }
